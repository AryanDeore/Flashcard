...
EXPERT_PROMPT = "Explain {topic} and its process in {domain} to me like I am a subject matter expert. Provide a detailed explanation with step-by-step procedure in 8 steps."
